...
(
    ...
    utncoin_amount  DOUBLE PRECISION,
    bitcoin_amount  DOUBLE PRECISION,
    monero_amount   DOUBLE PRECISION,
    ethereum_amount DOUBLE PRECISION
);
...
(
    ...
    utn_amount                DOUBLE PRECISION      NOT NULL,
    cryptocurrency            VARCHAR(50) NOT NULL,
    crypto_amount             DOUBLE PRECISION      NOT NULL,
    current_dollar_blue_value DOUBLE PRECISION      NOT NULL,
    current_crypto_value      DOUBLE PRECISION      NOT NULL,
    FOREIGN KEY (user_id) REFERENCES users (id)
);
